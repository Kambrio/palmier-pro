        ...
        AgentTool(
            ...
            inputSchema: objectSchema(
                properties: [
                    ...
                    "voice": ["type": "string", "description": "TTS only. Voice preset name. list_models shows voicesSample (first 3) + voiceCount; any voice supported by the model is accepted. Defaults to the model's defaultVoice. Ignored by music models. For the local omnivoice-local model, pass the mediaRef of an audio asset to clone its voice."],
                    "language": ["type": "string", "description": "TTS language for the local OmniVoice provider — a language name (English, Spanish) or ISO code (en, es). Ignored by cloud TTS models."],
                    ...
                    "styleInstructions": ["type": "string", "description": "Gemini TTS only. Optional delivery instructions (e.g. 'warm and slow', 'British accent'). For omnivoice-local, this drives voice design (e.g. \"female, british accent, whisper\")."],
