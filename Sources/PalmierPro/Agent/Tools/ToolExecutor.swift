...
final class ToolExecutor {
    ...
    private func run(_ tool: ToolName, _ editor: EditorViewModel, _ args: [String: Any]) async throws -> ToolResult {
        ...
        case .getShotLibrary: return try getShotLibrary(editor, args)
        case .setShot:        return try setShot(editor, args)
        case .getStoryGraph:  return try getStoryGraph(editor, args)
        case .addStoryNodes:  return try addStoryNodes(editor, args)
        case .setStoryNode:   return try setStoryNode(editor, args)
        case .removeStoryNode: return try removeStoryNode(editor, args)
